...
filename = "xtraj_E_4dof_control_pd+.mat"; % "xtraj_KE_5dof.mat" "xtraj_KE_5dof_damp.mat" "xtraj_KE_5dof_dampgrav.mat"
if ~isfile(filename)
    grav = 1;
    ...
    for i=2:n
        res = solve_4dof_pidgrav(x_traj(:,i-1), xd, sigma, dt, damp_mat, grav); %solve_4dof_pdgrav(x_traj(:,i-1), xd, damp_mat, grav);
